      ...
      while True:
         for task in content.taskManager.recentTask:
            try:
               ...
               # Only print new *tasks*
               # FIXME: Running task will never show *success* and will be
               #        removed from the recentTasks queue.
               #        Logic is based on task-<num> for checking and cleaning
               #        the queue. (taskNum > lastTask)
