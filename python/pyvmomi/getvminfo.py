...
def GetVmInfo(vm):
   ...
   #vminfo["guestFullName"] = summary.config.guestFullName
   ...
   #vminfo["macAddress"] = vm.config.hardware.device[4000].macAddress
   #print vminfo
   #print summary.config.name
   #print summary.config.memorySizeMB 
   #print vm.config.hardware.device[4000].macAddress
...
def main():
   ...
   try:
      ...
      targetvm = find_vm(si,args.vmname)
      GetVmInfo(targetvm)
